           ...
           try{
                ...
                <div class="course_box">
                    ...
                    <div class="detail_box">
                        ...
                        <%
                        String link=rs.getString("course_link");
                        String desc=rs.getString("course_desc");
                        String name=rs.getString("course_name");
                        %>
                        <a class="play_link" href="play_video.jsp?video_link=<%=link %>&video_name=<%=name %>&video_desc=<%=desc %>">
                            <div class="play_link_button">Click here to play</div>
                        </a>
